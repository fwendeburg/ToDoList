...
class ToDo {
    ...
    static getDueTodayTasks = () => {
        ...
        for (let i = 0; i < this.projects.length; i++) {
            ...
            for (let j = 0; j < projectTasks.length; j++) {
                if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(projectTasks[j].getDueDate())) {
    ...
    static getDueThisWeekTasks = () => {
        let tasks = [];
        let nextWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(), 7);

        for (let i = 0; i < this.projects.length; i++) {
            let projectTasks = this.projects[i].getTasks();

            for (let j = 0; j < projectTasks.length; j++) {
                if ((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)(projectTasks[j].getDueDate(), nextWeek) != 1) {
                    tasks.push(projectTasks[j]);
                }
            }
        }
...
class UI {
                ...
                <div class="inputs">
                    ...
                    <div class="new-task-modal-right-panel">
                        <div class="task-property">
                            <label>Due date</label>
                            <br>
                            <input type="date" id="task-duedate-input" value="${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(taskInfo[2], 'yyyy-MM-dd')}">
                        </div>
                        <div class="task-property">
                            <label>Priority</label>
                            <br>
                ...
                <div class="properties">
                    ...
                    <div class="show-task-modal-right-panel">
                        <div class="task-property">
                            ...
                            <p>${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(taskInfo[2], "yyyy/MM/dd")}</p>
                        </div>
                        <div class="task-property">
    ...
    static addNewTask = (name, dueDate, priority, id) => {
        ...
        <div class="task" data-taskid ="${id}">
                <div class="left-panel">
                    ...
                    <label>${name} - ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(dueDate, "yyyy/MM/dd")}</label>
                </div>
    ...
    static #handleTaskEdit(id) {
        ...
        const newTaskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(document.querySelector('#task-duedate-input').value);
    ...
    static #updateTaskEntry(taskId, name, dueDate, priority) {
        ...
        taskName.innerText = `${name} - ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(dueDate, "yyyy/MM/dd")}`;
